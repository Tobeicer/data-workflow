...
| 路径 | 用途 |
|---|---|
| `docs/` | 唯一执行基线、统一技术设计、唯一建设路线图、分类参考和历史需求 |
...
3. 实施任务再读 `docs/数据工作流建设路线图.md` 的当前执行点和对应任务
4. 对应的 `data-workflow/adapters/<source>/README.md`
...
| `docs/数据工作流建设路线图.md` | 唯一实施路线图：任务依赖、状态、测试、验收和下一执行点 |
