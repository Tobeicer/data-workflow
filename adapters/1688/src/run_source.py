...
def main() -> None:
    ...
    sample_parser.add_argument("--delay-seconds", type=float, default=5.0)
    ...
    validate_parser.add_argument("--delay-seconds", type=float, default=5.0)
    validate_parser.add_argument("--scroll-count", type=int, default=1)
    validate_parser.add_argument("--collection-delay-seconds", type=float, default=5.0)
