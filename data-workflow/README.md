...
七个来源分别使用独立 adapter 和来源 workflow；来源状态与启用值只以 `orchestration/n8n/configs/source_registry.json` 为准。来源差异和混合字段模型以 `../docs/数据工作流总体技术设计.md` 为准，任务顺序与进度只以 `../docs/数据工作流建设路线图.md` 为准；平台映射、搜索关键词、包含和排除规则只以 `../docs/游艺圈游戏游艺设备完整分类清单.md` 为准。
