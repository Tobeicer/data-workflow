...
状态：目录契约已建立；七个来源全部禁用，当前没有可标为 `active` 的工作流 JSON。`workflows/` 下仅有微信实验来源的 `wechat_collect.json`（Phase H，不属于七来源注册表）。

唯一现行总纲：`../../docs/游艺圈数据工作流总纲.md`。控制面设计、实施顺序、测试和验收只在总纲维护；本 README 只保存 n8n 目录与启用规则。
